      ...
      body: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildButton('C', flex: 2, color: Colors.red, textColor: Colors.white),
              _buildButton('()'),
              _buildButton('/'),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              _buildButton('7', textColor: Colors.black, color: Colors.white),
              _buildButton('8', textColor: Colors.black, color: Colors.white),
              _buildButton('9', textColor: Colors.black, color: Colors.white),
              _buildButton('*', textColor: Colors.white, color: Colors.grey[800]),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              _buildButton('4', textColor: Colors.black, color: Colors.white),
              _buildButton('5', textColor: Colors.black, color: Colors.white),
              _buildButton('6', textColor: Colors.black, color: Colors.white),
              _buildButton('-', textColor: Colors.white, color: Colors.grey[800]),
            ],
          ),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              _buildButton('1', textColor: Colors.black, color: Colors.white),
              _buildButton('2', textColor: Colors.black, color: Colors.white),
              _buildButton('3', textColor: Colors.black, color: Colors.white),
              _buildButton('+', textColor: Colors.white, color: Colors.grey[800]),
            ],
          ),
          Row(
